...
@IBDesignable open class GradientView: UIView {
    ...
    @objc public enum Direction: Int {
        ...
        //The gradient is diagonal
        case diagonal
        
        /// Returns the start point for a specific size depending on self
        ///
        /// - Parameter forSize: the concerned size
        func startPoint(forSize size: CGSize) -> CGPoint {
            
            return .zero
        }
        
        /// Returns the end point for a specific size depending on self
        ///
        /// - Parameter forSize: the concerned size
        func endPoint(forSize size: CGSize) -> CGPoint {
    ...
    override open func draw(_ rect: CGRect) {
        ...
        if let gradient = gradient {
            ...
            if mode == .linear {
                let startPoint = direction.startPoint(forSize: size)
                let endPoint = direction.endPoint(forSize: size)
